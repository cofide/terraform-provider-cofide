...
page_title: "cofide_connect_role_binding_v1alpha1 Resource - terraform-provider-cofide"
subcategory: ""
description: |-
...
# cofide_connect_role_binding_v1alpha1 (Resource)
...
```terraform
import {
  to = cofide_connect_role_binding_v1alpha1.example
  id = "example-role-binding-id"
}
```
