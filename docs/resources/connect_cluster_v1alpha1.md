...
page_title: "cofide_connect_cluster_v1alpha1 Resource - terraform-provider-cofide"
subcategory: ""
description: |-
  Manages a Cofide Connect cluster. A cluster represents a Kubernetes cluster registered with a trust zone.
---

# cofide_connect_cluster_v1alpha1 (Resource)
...
output "cluster_id" {
  ...
  value       = cofide_connect_cluster_v1alpha1.example.id
}
