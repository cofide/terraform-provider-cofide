...
page_title: "cofide_connect_exchange_policy_v1alpha1 Data Source - terraform-provider-cofide"
subcategory: ""
description: |-
  Provides information about a Cofide Connect exchange policy.
---

# cofide_connect_exchange_policy_v1alpha1 (Data Source)
...
output "exchange_policy_id" {
  description = "The ID of the exchange policy."
  value       = data.cofide_connect_exchange_policy_v1alpha1.example.id
}
```
...
- `outbound_issuer` (Attributes) Outbound token issuer configuration. (see [below for nested schema](#nestedatt--outbound_issuer))
