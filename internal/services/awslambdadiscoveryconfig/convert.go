...
// modelToProto converts a Model to an AWSLambdaDiscoveryConfig proto message.
func modelToProto(ctx context.Context, model Model) (*cloudaccountpb.AWSLambdaDiscoveryConfig, diag.Diagnostics) {
...
// protoToModel converts an AWSLambdaDiscoveryConfig proto message to a Model.
func protoToModel(cloudAccountID string, proto *cloudaccountpb.AWSLambdaDiscoveryConfig) Model {
	return Model{
