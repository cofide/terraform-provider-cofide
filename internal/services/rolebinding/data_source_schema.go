...
func dataSourceSchema() schema.Schema {
	return schema.Schema{
		MarkdownDescription: "Provides information about a role binding resource.",
		Attributes: map[string]schema.Attribute{
			...
			"user": schema.SingleNestedAttribute{
				Description: "The user principal for the role binding.",
				Optional:    true,
				Computed:    true,
				Attributes: map[string]schema.Attribute{
			...
			"group": schema.SingleNestedAttribute{
				Description: "The group principal for the role binding.",
				Optional:    true,
				Computed:    true,
				Attributes: map[string]schema.Attribute{
