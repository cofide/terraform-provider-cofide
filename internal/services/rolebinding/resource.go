...
func NewResource() resource.Resource {
	return &RoleBindingResource{RoleBindingResource: v1alpha1.RoleBindingResource{}}
}

func (t *RoleBindingResource) Metadata(ctx context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_connect_role_binding"
}

func (t *RoleBindingResource) Schema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse) {
